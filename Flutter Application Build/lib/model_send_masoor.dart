...
class MainChooserc extends StatefulWidget {
  MainChooserc({Key? key}) : super(key: key);

  @override
  State<MainChooserc> createState() => _MainChoosercState();
}

class _MainChoosercState extends State<MainChooserc> {
  File? image;
  int count = 0;
  String? text;
                    ...
                    content: Row(children: <Widget>[
                      ElevatedButton(
                          onPressed: () async {
                            ...
                            count = 0;
                            var modelpath = "M" + image!.path.toString();
                            final _result =
