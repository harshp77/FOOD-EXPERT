...
class MainChoosera extends StatefulWidget {
  MainChoosera({Key? key}) : super(key: key);

  @override
  State<MainChoosera> createState() => _MainChooseraState();
}

class _MainChooseraState extends State<MainChoosera> {
  File? image;
  int count = 0;
  String? text;
                    ...
                    content: Row(children: <Widget>[
                      ElevatedButton(
                          onPressed: () async {
                            ...
                            count = 0;
                            var modelpath = "A" + image!.path.toString();
                            final _result =
